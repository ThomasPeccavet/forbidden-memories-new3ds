...
short * FUN_80088948(short *param_1,short *param_2)

{
  ...
  uVar4 = (uint)*param_1;
  if ((int)uVar4 < 0) {
    iVar6 = *(int *)(&DAT_80096938 + (-uVar4 & 0xfff) * 4);
  ...
  if ((int)uVar4 < 0) {
    iVar7 = *(int *)(&DAT_80096938 + (-uVar4 & 0xfff) * 4);
  ...
  if ((int)uVar4 < 0) {
    param_2[8] = sVar3;
    iVar8 = *(int *)(&DAT_80096938 + (-uVar4 & 0xfff) * 4);
