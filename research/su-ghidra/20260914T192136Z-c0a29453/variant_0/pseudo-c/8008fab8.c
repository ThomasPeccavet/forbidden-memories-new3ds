...
undefined1 * FUN_8008fab8(undefined4 param_1,byte *param_2,uint *param_3)

{
  ...
  if (param_2 == (byte *)0x0) {
    ...
    local_30 = s_0123456789abcdef_8001256c;
    local_40 = (undefined1 *)0x0;
LAB_8008fb08:
    uVar9 = (uint)*param_2;
    if (uVar9 != 0) {
...
LAB_8008fb34:
        ...
        case 0x2a:
          ...
          puVar13 = puVar12;
          pbVar20 = param_2;
          if (-1 < (int)local_34) goto LAB_8008fb34;
        ...
        case 0x2e:
          ...
          if (bVar1 == 0x2a) {
            ...
            while ((bVar1 < 0x80 && (bVar2 = *pbVar20, ((&DAT_8009b279)[bVar2] & 4) != 0))) {
              pbVar20 = pbVar20 + 1;
              bVar1 = *pbVar20;
        ...
        case 0x39:
          ...
          } while (((&DAT_8009b279)[*param_2] & 4) != 0);
          goto LAB_8008fb34;
        case 0x44:
          bVar5 = true;
        case 100:
...
LAB_8008fe80:
        ...
        case 0x75:
          ...
          goto LAB_8008fe84;
        case 0x58:
          local_30 = s_0123456789ABCDEF_80012588;
        case 0x78:
          if ((bVar5) || (!bVar6)) {
            uVar9 = *puVar13;
          }
        ...
        case 0x68:
          ...
          goto LAB_8008fb34;
        case 0x6c:
          goto switchD_8008fb5c_caseD_6c;
        case 0x6e:
          if ((bVar5) || (!bVar6)) {
            param_3 = puVar13 + 1;
        ...
        case 0x73:
          ...
          if ((undefined1 **)pcVar15 == (undefined1 **)0x0) {
            pcVar15 = s__null__80012580;
          }
          if ((int)puVar17 < 0) {
            puVar17 = (undefined1 *)FUN_8008f948(pcVar15);
          }
          else {
            iVar8 = FUN_80090158(pcVar15,0,puVar17);
            if ((iVar8 != 0) &&
               (iVar21 = 0, puVar19 = (undefined1 *)(iVar8 - (int)pcVar15),
               iVar8 - (int)pcVar15 <= (int)puVar17)) goto LAB_8008ff24;
          }
          iVar21 = 0;
          puVar19 = puVar17;
          goto LAB_8008ff24;
...
switchD_8008fb5c_caseD_0:
    FUN_800902a4();
  }
  return local_40;
switchD_8008fb5c_caseD_6c:
  bVar5 = true;
  pbVar20 = param_2;
  goto LAB_8008fb34;
LAB_8008feac:
  ...
  if (bVar7) {
    ...
    if ((uVar10 != 8) || (puVar19 = auStack_78 + -(int)pcVar15, cVar3 == '0')) goto LAB_8008ff20;
