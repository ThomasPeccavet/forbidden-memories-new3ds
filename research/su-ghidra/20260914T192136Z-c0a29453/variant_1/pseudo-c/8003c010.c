...
void FUN_8003c010(undefined2 *param_1,int param_2)

{
  undefined *puVar1;
  
  if (param_2 == 1) {
    *(undefined4 *)(param_1 + 0xe) = 0x2000;
    puVar1 = DAT_8009c4b0;
  }
  else {
    if (param_2 < 2) {
      ...
      *(undefined1 *)(param_1 + 0x23) = 2;
      puVar1 = DAT_8009c4b0;
      *(undefined4 *)(param_1 + 0xe) = 0x20000;
    ...
    if (param_2 == 2) {
      ...
      *(undefined4 **)(param_1 + 6) = &DAT_801a8000;
      *(undefined4 **)(param_1 + 4) = &DAT_801a8000;
      *(undefined4 *)(param_1 + 0xe) = 0x1800;
