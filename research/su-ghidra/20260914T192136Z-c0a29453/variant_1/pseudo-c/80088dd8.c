...
void FUN_80088dd8(int *param_1,uint *param_2)

{
  ...
  uVar2 = *(int *)(&DAT_80096938 + (((iVar16 >> 0x10) + uVar12 ^ uVar12) & 0xfff) * 4) * 0x10000 +
          uVar12 ^ uVar12;
  uVar3 = uVar2 >> 0x10;
  uVar4 = *(int *)(&DAT_80096938 + (((int)(short)iVar16 + uVar10 ^ uVar10) & 0xfff) * 4) * 0x10000 +
          uVar10 ^ uVar10;
  iVar8 = (int)((*(int *)(&DAT_80096938 + (((int)(short)iVar16 + uVar10 ^ uVar10) & 0xfff) * 4) >>
  ...
  iVar5 = (int)((*(int *)(&DAT_80096938 + (((int)(short)param_1[1] + uVar14 ^ uVar14) & 0xfff) * 4)
                >> 0x10) << 0x10 | uVar1 >> 0x10) >> 0x10;
  setCopReg(2,0x5800,iVar5);
  copFunction(2,0x198003d);
  iVar16 = (int)((*(int *)(&DAT_80096938 + (((iVar16 >> 0x10) + uVar12 ^ uVar12) & 0xfff) * 4) >>
