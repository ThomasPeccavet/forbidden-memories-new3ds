...

{
  ...
  if (uVar18 != 0) {
    iVar7 = param_1[6];
    iVar8 = param_1[7];
    setCopReg(2,0x3000,DAT_8009c348);
    uVar16 = param_1[2];
    iVar17 = *(int *)(param_1[1] + 4);
    do {
      uVar10 = (int)puVar9 + 10U & 3;
      uVar10 = puVar9[3] & -1 << (4 - uVar10) * 8 |
               *(uint *)(((int)puVar9 + 10U) - uVar10) >> uVar10 * 8;
      uVar11 = puVar9[4];
      uVar12 = puVar9[5];
      uVar13 = puVar9[6];
      puVar15 = (undefined4 *)((uVar10 >> 0x10) * 8 + iVar7);
      setCopReg(2,in_zero,*puVar15);
      setCopReg(2,in_at,puVar15[1]);
      puVar15 = (undefined4 *)((uVar11 >> 0x10) * 8 + iVar7);
      setCopReg(2,in_v0,*puVar15);
      setCopReg(2,in_v1,puVar15[1]);
      puVar15 = (undefined4 *)((uVar12 >> 0x10) * 8 + iVar7);
      setCopReg(2,param_1,*puVar15);
      setCopReg(2,iVar7,puVar15[1]);
      copFunction(2,0x280030);
      in_at = 1;
      puVar15 = (undefined4 *)((uVar13 >> 0x10) * 8 + iVar7);
      if (cVar6 == '\x01') {
LAB_8004d374:
        setCopReg(2,in_zero,*puVar15);
        setCopReg(2,1,puVar15[1]);
        uVar14 = getCopReg(2,0xc);
        DAT_800ff5c4[2] = uVar14;
        uVar14 = getCopReg(2,0xd);
        DAT_800ff5c4[5] = uVar14;
        uVar14 = getCopReg(2,0xe);
        DAT_800ff5c4[8] = uVar14;
        copFunction(2,0x180001);
        in_at = 1;
        if ((cVar6 == '\x01') || (in_v0 = (uint *)getCopControlWord(2,0xf800), -1 < (int)in_v0)) {
          copFunction(2,0x168002e);
          uVar14 = getCopReg(2,0xe);
          DAT_800ff5c4[0xb] = uVar14;
          puVar15 = (undefined4 *)((uVar13 & 0xffff) * 8 + iVar8);
          if (cVar6 == '\0') {
            uVar11 = *(uint *)((uVar11 & 0xffff) * 4 + iVar5);
            uVar12 = *(uint *)((uVar12 & 0xffff) * 4 + iVar5);
            uVar13 = *(uint *)((uVar13 & 0xffff) * 4 + iVar5);
            DAT_800ff5c4[1] = *(uint *)((uVar10 & 0xffff) * 4 + iVar5);
            DAT_800ff5c4[4] = uVar11;
            DAT_800ff5c4[7] = uVar12;
            DAT_800ff5c4[10] = uVar13;
            *(char *)((int)DAT_800ff5c4 + 7) = (char)(uVar2 >> 0x18);
            ...
            puVar15 = (undefined4 *)((uVar10 & 0xffff) * 8 + iVar8);
            setCopReg(2,in_zero,*puVar15);
            setCopReg(2,1,puVar15[1]);
            puVar15 = (undefined4 *)((uVar11 & 0xffff) * 8 + iVar8);
            setCopReg(2,in_v0,*puVar15);
            setCopReg(2,in_v1,puVar15[1]);
            puVar15 = (undefined4 *)((uVar12 & 0xffff) * 8 + iVar8);
            setCopReg(2,param_1,*puVar15);
            setCopReg(2,iVar7,puVar15[1]);
            if (iVar5 != 0) {
              uVar1 = getCopReg(2,0x16);
              *(undefined4 *)((uVar13 & 0xffff) * 4 + iVar5) = uVar1;
            }
            ...
            in_at = 1;
            if (cVar6 == '\x01') goto LAB_8004d57c;
          }
          uVar11 = *puVar9;
          uVar13 = puVar9[2];
          uVar14 = puVar9[3];
          ...
          while( true ) {
            ...
            DAT_800ff5c4[0xc] = uVar14;
            in_at = uVar10 & 0xffffff;
            *DAT_800ff5c4 = in_at | 0xc000000;
            uVar10 = (uint)DAT_800ff5c4 & 0xffffff;
            *in_v0 = uVar10;
            if ((in_v1 == 0) || (uVar4 == 0)) break;
            uVar11 = uVar11 & 0xffff | uVar4;
            uVar12 = uVar12 & 0xff9fffff | 0x400000;
            DAT_800ff5c4[0xe] = uVar2;
            DAT_800ff5c4[0xf] = DAT_800ff5c4[2];
            DAT_800ff5c4[0x11] = uVar2;
            DAT_800ff5c4[0x12] = DAT_800ff5c4[5];
            DAT_800ff5c4[0x14] = uVar2;
            DAT_800ff5c4[0x15] = DAT_800ff5c4[8];
            DAT_800ff5c4[0x17] = uVar2;
            DAT_800ff5c4[0x18] = DAT_800ff5c4[0xb];
            DAT_800ff5c4 = DAT_800ff5c4 + 0xd;
            in_v1 = 0;
          }
          DAT_800ff5c4 = DAT_800ff5c4 + 0xd;
        }
        ...
        if (-1 < (int)in_v0) {
          ...
          if (0 < (int)in_v0) goto LAB_8004d374;
        }
      }
LAB_8004d57c:
      uVar18 = uVar18 - 1;
