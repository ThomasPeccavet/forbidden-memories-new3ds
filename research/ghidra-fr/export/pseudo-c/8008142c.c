...
/* WARNING: Removing unreachable block (ram,0x80081598) */

undefined4 FUN_8008142c(undefined4 *param_1,undefined4 *param_2)

{
  ...
  *(short *)(param_1 + 1) = sVar5;
  if (*(short *)((int)param_1 + 6) < 0) {
    ...
    sVar5 = DAT_80095a9e;
    if (*(short *)((int)param_1 + 6) <= DAT_80095a9e) goto LAB_800814d4;
  }
  sVar6 = sVar5;
LAB_800814d4:
