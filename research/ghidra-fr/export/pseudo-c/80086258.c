...
void FUN_80086258(int *param_1,int *param_2)

{
  ...
  iVar3 = 100;
  do {
    (&DAT_800ff530)[iVar7] = (int)param_1;
    iVar2 = DAT_800ff530;
    if ((int *)param_1[0x12] == (int *)0x0) {
      if ((*param_1 == DAT_800ff450) || (*param_1 == 0)) {
        ...
        *param_1 = iVar3;
        ...
        iVar7 = iVar3 + 1;
        if (iVar3 == 100) {
          iVar3 = *(int *)(DAT_800ff530 + 0x28);
          iVar7 = *(int *)(DAT_800ff530 + 0x2c);
          iVar4 = *(int *)(DAT_800ff530 + 0x30);
          *param_2 = *(int *)(DAT_800ff530 + 0x24);
          param_2[1] = iVar3;
          param_2[2] = iVar7;
          param_2[3] = iVar4;
...
LAB_80086474:
      ...
      FUN_80086528(&DAT_800ff4d0,param_2);
      return;
    }
