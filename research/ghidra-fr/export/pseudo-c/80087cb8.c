...
undefined2 * FUN_80087cb8(short *param_1,undefined2 *param_2)

{
  ...
  uVar6 = (uint)*param_1;
  if ((int)uVar6 < 0) {
    iVar7 = *(int *)(&DAT_80096938 + (-uVar6 & 0xfff) * 4);
  ...
  if ((int)uVar6 < 0) {
    iVar8 = *(int *)(&DAT_80096938 + (-uVar6 & 0xfff) * 4);
  ...
  if ((int)uVar6 < 0) {
    param_2[8] = uVar5;
    iVar9 = *(int *)(&DAT_80096938 + (-uVar6 & 0xfff) * 4);
